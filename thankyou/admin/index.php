                ...
                <div class="container-fluid" >
                    ...
                    <form method="post" action="actions/function.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3 mb-2">
                            ...
                            <input type="file" name="image1" class="form-control-file" id="exampleFormControlFile1" multiple>
                        </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea type="text" class="form-control" name="blog" rows="5" id="comment"></textarea>
                        </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="img/<?php echo $showdata['image1']; ?>" width="70" height="70"></td>
