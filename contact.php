...
<head>
   <meta charset="UTF-8">
    ...
    <meta property="og:url" content="https://www.sartor.io/contact">
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="website">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta content= "Contact Us | SARTOR: " name="title">
    ...
    <meta itemprop="name" content="Contact Us | SARTOR"/>
...
<meta itemprop="image" content="https://www.sartor.io/gallery/img/sartor1.png"/>
  ...
  window.rrmc_trigger_delayed_attribute = function(attribute, value, delay)
  {
    ...
    <link rel="icon" href="/gallery/img/logo.png" type="image/gif" sizes="16x16">
      ...
      <script src="https://kit.fontawesome.com/5adf76837d.js" crossorigin="anonymous"></script>
...
<body>
   ...
   <div class="cursor"></div>
                    ...
                    <div class="main-menu mobile-menu">
                        ...
                        <a href="#" role="menuitem" >
                         ...
                         <ul class="dropdown" role="menu" aria-hidden="false" style="">
                            ...
                            <li> <div class="buttonic">
                               <a href="./contact.php"> <div class="btn btn-five"><span> Contact </span></div></a>
                               </div>
                            </li>
    ...
    <div class="map">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3116.7581639414047!2d-90.19537648433074!3d38.631444170181084!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87d8b31eeb040231%3A0x66b282295534906a!2sT-REX!5e0!3m2!1sen!2sus!4v1601001577116!5m2!1sen!2sus"
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="contact-option">
                        ...
                        <form action="/admin/actions/contantus.php" method="POST" id="wf-form-Email-Hero" class="comment-form contact-form">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" name="name" placeholder="Name">
                                </div>
                                <div class="col-lg-6">
                                    <input type="email" name="email" id="con-email" placeholder="Email" required>
                                </div>

                                <div class="col-lg-12">
                                    
                             <textarea  type=text name="message" rows="4" cols="50" placeholder="message"> </textarea>       
                        
                            <button class="btn btn-three" name="submit" type="submit" id="contantus" >send message</button>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-option">
                        <div class="fo-logo"> <button class="bt btn-three">
                            <a href="./index.php">
               ...
               <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <p>Get E-mail updates about our latest shop and special offers.</p>
                                 ...
                                 <form action="/admin/actions/customersub.php" class="news-form" method="POST" id="wf-form-Email-Hero1">
...
$(document).ready(function(){
     $("#contantus").hide();
     $("#con-email").keyup(function(){
			if(validateEmail()){
				// if the email is validated
				// set input email border green
				$("#con-email").css("border","2px solid green");
				// and set label 
				$("#emailMsg").html("<p class='text-success'>Validated</p>");
			}else{
				// if the email is not validated
				// set border red
				$("#con-email").css("border","2px solid red");
				$("#emailMsg").html("<p class='text-danger'>Un-validated</p>");
			}
			buttonState();
		});

  $("#contantus").click(function(e){ 
        e.preventDefault();
        var datastring = $("#wf-form-Email-Hero").serialize();
        if (document.querySelector('[type=text]','[type=email]','[type=text]').value) {
            
        
        $.ajax({
            type: "POST",
            url: "/admin/actions/contantus.php",
            data: datastring,
            dataType: "html",
            success: function(data) {
